...
- Express aknowledgements to those that have helped me during my thesis:
		...
		- Dr. Anne Clark
		- Ian Gordon
		- Gotanda Lab-mates: Alex W. & Albert W. get aknowledged explicitly
		- Lily
		- Family
...
- I'm hoping this will make explanations of concepts easier for the reader.

## Declaration of Academic Achievement
- Outline who contributed on what chapter of the thesis.
	- Alex Popescu: Throughout
	- Dr. Gotanda: Throughout
...
### 1.1 Urbanization
- Define urbanization & what it entails.
...
- Give examples of urbanized species, and provide examples where the abundance increases following urbanization
...
- Sentinel behavior and urbanization
	- Urbanization could affect sentinel behavior, and groups with more sentinels will outperform groups with fewer sentinels.
		- Introduction to multilevel selection theory
		- Assuming sentinel behavior is altruistic, then sentinels are outperformed by nonsentinels. However, groups with sentinels outperform groups without sentinels.
...
### 2.5 Conclusion & Linking Statement
...
- Supplemental feeding/baiting + observation
- 2-3 hours following sunrise, 2-3 hours before sunset
...
- In addition to the behavioral measurements, we measured some other variables to better quanlify the environment
